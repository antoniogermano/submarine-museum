    ...
    var body: some View {
        ...
        VStack {
            Text("Explore debug settings", comment: "The title of the settings presented to the viewer.")
                .font(.title)
            Form {
                ExploreHotspotSettingsSection(
                    configuration: $model.exploreSubmarine,
                    selectedHotspotID: $model.exploreSelectedHotspotID
                )
                ExploreWaypointSettingsSection(
                    configuration: $model.exploreSubmarine,
                    selectedWaypointID: $model.exploreSelectedWaypointID
                )
                ExploreModelSettingsSection(configuration: $model.exploreSubmarine)
                ExhibitPreviewSettingsSection(configuration: $model.previewSubmarine)
